...
import { ref } from "vue";
import FocalMechanismGuess from "./FocalMechanismGuess.vue";

type LearnGame = "menu" | "focal-mechanism";

const learnGame = ref<LearnGame>("menu");
</script>

<template>
  <div v-if="learnGame === 'menu'" class="game-grid">
    <button class="game-card" type="button" @click="learnGame = 'focal-mechanism'">
      ...
      <span class="game-card-content">
        <span class="game-card-title">FOCAL MECHANISMS</span>
        <span class="game-card-description">Learn how to identify beach balls!</span>
  ...
  <FocalMechanismGuess v-else-if="learnGame === 'focal-mechanism'" />
